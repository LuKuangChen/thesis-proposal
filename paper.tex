...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.8\textwidth]{images/smol-quizzes-example.png}
...
\begin{table}[t]
  ...
  \begin{tabularx}{\linewidth}{l l}
    \textbf{Questions}                       &
    \textbf{Frequency Table of Answers}          \\\hline
    \lstinputlisting{programs/def_twice.txt} & {
        \begin{tabularx}{1in}{r l}
          $^\dag$59\%  & \verb|2 0|             \\
          *32\% & \verb|Error|           \\
          4\%   & \verb|Other: 2 2|      \\
...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.8\textwidth]{images/smol-tutor-example.png}
...
\begin{table}[t]
  % \begin{tabularx}{250pt}{|c|X|c|X|} \end{tabularx}
  \centering\begin{tabularx}{\linewidth}{
...
misconception.\footnote{An astute reader may well imagine another
  ...
  \begin{table}[t]
    \centering
    \begin{tabularx}{\linewidth}{m{0.3\textwidth} l l}
      \textbf{Misconception}                                                     &
      \textbf{Question}                                                          &
      ...
      \lstinputlisting{programs/def-by-ref.txt}                                  & {
          \begin{tabularx}{1in}{r p{0.2\textwidth}}
            85\%   & \verb|0 12|                \\
            **12\% & \verb|0 0|                 \\
            2\%    & \verb|error|               \\
...
\begin{figure}[t]
  ...
  \includegraphics[width=1\textwidth]{images/Misconceptions_Decay.png}
