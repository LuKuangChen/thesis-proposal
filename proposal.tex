...
\emph{Case comparisons} draws analogies between examples.
...
napsExploringRoleVisualization2002}. These visualization seems to
increase engadgments and help students understand how programs works.
...
a langauge has better be taught as a sequence of languages, where each
later language includes more langauge constructs than the previous
one.
