...
\begin{description}
  ...
  draws on cognitive and educational psychology concepts and that aim
  at correcting the misconceptions?
...
\begin{enumerate}
  ...
  \item We implement these misconceptions as interpreters, which
        find weaknesses in our manual analysis and hold potential for
        generative use in the future.

  \item We present a tutoring system, the SMoL Tutor, that measurably
...
this issue. We defer this to future work (\cref{s:future-work}).
