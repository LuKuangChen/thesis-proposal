...
\usepackage{natbib} % to put \cite{...} in brackets
\usepackage{hyperref}
...
C\# language \emph{changed} to produce \lstinline|0| through \lstinline|9| \cite{lippertClosingLoopVariable2009}. It is now also the focus of a language design
...
as a \lstinline|#lang| language inside Racket \cite{felleisenProgrammableProgrammingLanguage2018}. This language
