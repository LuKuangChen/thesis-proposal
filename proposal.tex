...
plans for the RQs (\Cref{s:plan-rq1,s:plan-rq2}). After that, I describe preliminary results (\Cref{s:preliminary-results} and propose my next steps (\Cref{s:future-work}).
