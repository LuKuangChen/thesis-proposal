...
My plan is to change the tutor so that it provides a
...
interpreting tasks is not randomized. I plan to tackle the first two
...
\begin{enumerate}
  ...
  \item Adjust the collection of interpreting questions such that
        every misconception has at least two questions that aim at
...
more rigorous evaluation of the effectiveness of SMoL Tutor. The
