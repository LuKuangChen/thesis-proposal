...
the programs. This limits my ability to claim that the tutor is using
NM to help teach.
...
\begin{enumerate}
  \item The tutor currently does not ask students to explain when they
        gave a wrong answer in an interpreting question. This limits my
  ...
  \item The tutor is not randomizing the order of questions. This makes
  ...
  \item The tutor uses many variable names, some are separated by dashes
...
data that I collected in Spring 2024, and hopefully write a paper about the
updates.
